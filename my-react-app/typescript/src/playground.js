...
var employee1 = __assign({}, employee);
...
var deepclone = JSON.parse(JSON.stringify(employee));
deepclone.department.name = "deep";
console.log(employee, "employee");
console.log(deepclone, "deepclone");
var deep2 = structuredClone(employee);
...
// */
var allowedClient = { id: 1, password: "123", secret: 'abcd' };
var sensitiveKeys = ['password', 'secret'];
var maskData = function (obj, keys) {
    var res = {};
    for (var key in obj) {
...
// * output → (• id: 1, password: *****, secret:
var getAllowedClients = function () {
    return Promise.resolve(allowedClient);
};
var getSensitiveKeys = function () {
    return Promise.resolve(sensitiveKeys);
};
var processData = function (maskData) { return __awaiter(_this, void 0, void 0, function () {
    var _a, client, keys;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), client = _a[0], keys = _a[1];
                return [2 /*return*/, maskData(client, keys)];
        }
    });
}); };
processData(maskData).then(function (res) {
